/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 589cdc145ecccbfafbb970e0a774ebfa)
// Runtime types generated with workerd@1.20260903.1 2026-08-25 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "production";
	APP_ORIGIN: "https://csc-questionnaire-staging.jeff-poon.workers.dev" | "https://REPLACE_WITH_PRODUCTION_HOSTNAME";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_ORIGIN">> {}
}
