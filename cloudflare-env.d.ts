/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f22d0935435ec8ae3ea31158714458f8)
// Runtime types generated with workerd@1.20260903.1 2026-08-25 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "production";
	APP_ORIGIN: "https://csc-questionnaire-staging.jeff-poon.workers.dev" | "https://forms.REPLACE_WITH_CAREY_DOMAIN";
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "production";
		APP_ORIGIN: "https://forms.REPLACE_WITH_CAREY_DOMAIN";
	}
